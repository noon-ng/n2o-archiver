...
/// format with +signatures and +formatTypeForFileAtPath:. The format type is
...
/// Leading bytes that identify the format; canHandleFileAtPath: matches any.
+ (NSArray<NSData *> *)signatures;

/// The 7zz -t value for the file at path, such as @"7z".
